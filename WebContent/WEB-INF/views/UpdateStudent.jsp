        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit Student</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
			...
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                ...
                                %>
 <form autocomplete="off" method="POST" action="UpdateStudentServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
	 ...
	 <div class="row m-0 p-0">
	  <div class="col-md-6  h-100 w-100">
        ...
        <br />
             <input id="InNo" name="InNo" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required value="<%=student.getInNo()%>">
       ...
       <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                             <input id="Fname" name="Fname" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required value="<%=student.getFname()%>">
                    ...
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                             <input id="IName" name="IName" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=student.getIName()%>"  required>
                    </div>
				</div>
           <div class="row m-2 p-0"></div>
				<div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                             <input id="Address" name="Address" type="text" class="form-control" style="height: 60px; color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=student.getAddress()%>"  required>
                    </div>
                </div>
                <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
               ...
               <input type='text' id='Birthday' name='Birthday' class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=student.getBirthday()%>" required/>
             ...
             $('#datetimepicker3').datetimepicker({
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                             <input id="Guardian" name="Guardian" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=student.getGuardian()%>"  required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Mobile </label>
                        <br />
                            <input id="Mobile" name="Mobile" type="tel" pattern="^\d{10}$" maxlength="10" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" onkeypress="return onlyNumberKey(event)" value="<%=student.getMobile()%>" required>
                    </div>
				</div>
				<div class="row m-2 p-0"></div>
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Admission Date </label>
                        <br />
                        <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='ADate' name='ADate' class="form-control" style="color:#F8F8FF" onkeypress="return onlyNumberKey(event)" value="<%=student.getADate()%>" required/>
               <span class="input-group-addon">
               <span class="glyphicon glyphicon-time"></span>
               </span>
            </div>
             ...
             $('#datetimepicker3').datetimepicker({
                 format: 'LT',
                   ...
                   <br />
                        ...
                        <br />
                        <select id="position" name="position" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;"class="custom-select" required>
	<option selected value="<%=student.getPosition()%>"><%=student.getPosition()%></option>
    <option value="CLASS MONITOR">CLASS MONITOR</option>
    <option value="WISE MONITOR">WISE MONITOR</option>
    <option value="HEAD PREFECT">HEAD PREFECT</option>
    <option value="SEINER PREFECT">SEINER PREFECT</option>
    ...
    <option  value="STUDENT">STUDENT</option>
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                             <input id="Comment" name="Comment" type="text" class="form-control" style="height: 100px;  color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=student.getComment()%>"  required>
                    </div>
                </div>         
                <br>
		<input type="hidden" name="InNo" value="<%=student.getInNo()%>" /> 
					<div class="col-md-3  h-100 w-100">
