...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add Results</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
   ...
   <div class="row m-0 p-0">
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="sid" name="sid" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
     </div>
   <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
   ...
   <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <select id="year" name="year" class="form-control" style="color:#F8F8FF; font-size: 12px;  text-transform:uppercase;"class="custom-select" required>
   ...
   <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <select id="exam" name="exam" class="form-control" style="color:#F8F8FF; font-size: 12px; text-transform:uppercase;"class="custom-select" required>


    <option selected value="Pali Grammar & Literature">Pali Grammar & Literature</option>
    ...
    <option value="Theravada and Mahayana">Theravada and Mahayana</option>
       ...
       <div class="row m-0 p-0">       
        <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <select id="result" name="result" class="form-control" style="color:#F8F8FF; font-size: 12px;  text-transform:uppercase;"class="custom-select" required>
   ...
   <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="grade" name="grade" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
    </div> 
