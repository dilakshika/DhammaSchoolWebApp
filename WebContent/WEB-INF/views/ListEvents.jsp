...
<%@page import="com.itpm.service.EventServiceImpl"%>
<%@page import="com.itpm.service.IEventService"%>
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                           ...
                           <div class="row m-0 p-0">
     						<div class="col-md-6  h-100 w-100">
                   				...
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="eventView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
        ...
        <thead>
            <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; ">
                ...
                <th style="width: 210px;">Event Name</th>
                <th style="width: 210px;">Place</th>
                <th style="width: 210px;">Date</th>
                <th style="width: 210px;">Start Time</th>
        ...
        <tbody >
         <%
           IEventService iEventService = new EventServiceImpl();
			...
			%>
            <tr>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=event.getId() %> </td>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=event.getName() %>  </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=event.getPlace() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=event.getDate() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=event.getStime() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=event.getDuration() %> </td>	
                <td> 
             <table >
             <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetEventServlet">
				...
				<th>
				<form method="POST" action="GetEventUpdate">
				<input type="hidden" name="id" value="<%=event.getId() %>"/>
				...
				<th>
				<form method="POST" action="GetEventDeleteServlet">
				<input type="hidden" name="id" value="<%=event.getId() %>"/>
