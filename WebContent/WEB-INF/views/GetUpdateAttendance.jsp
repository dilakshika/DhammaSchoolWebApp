                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit Attendance</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
...
<form autocomplete="off" method="POST" action="UpdateAttendanceServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
	...
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="stdId" name="stdId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=attendance.getStdId() %>"   required>
                    </div>
                    </div>
...
<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="stdGrade" name="stdGrade" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=attendance.getStdGrade()%>"  required>
                    </div>
                    </div>
<div class="row m-0 p-0">
 <div class="col-md-8  h-100 w-100">
         <br />
                        ...
                        <br />
  <input type="time" name="stdArrivesTime" id="inputMDEx1" class="form-control" value="<%=attendance.getStdArrivesTime()%>">
                    </div>
    ...
    <div class="row m-0 p-0">
            ...
            <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='stdArrivesDate' name='stdArrivesDate' class="form-control" style="color:#F8F8FF" onkeypress="return onlyNumberKey(event)" value="<%=attendance.getStdArrivesDate()%>" required/>
