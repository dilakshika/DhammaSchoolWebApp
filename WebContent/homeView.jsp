    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add Student</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
			...
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                    <form autocomplete="off" method="POST" action="AddStudentServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
                <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        <br />
                    ...
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="IName" name="IName" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
				</div>
				...
				<div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br /> 
                        <textarea class="form-control" id="Address" name="Address"  style="height: 60px; font-size:12px; color:#F8F8FF; text-transform:uppercase" autocomplete="off" required></textarea>
               ...
               <input type='text' id='Birthday' name='Birthday' class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" required/>
      ...
      <script type="text/javascript">
         $(function () {
             $('#datetimepicker3').datetimepicker({
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="Guardian" name="Guardian" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Mobile </label>
                        <br />
                        <input id="Mobile" name="Mobile" type="tel" pattern="^\d{10}$" maxlength="10" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" onkeypress="return onlyNumberKey(event)" required>
                    </div>
				</div>
				<div class="row m-2 p-0"></div>
            ...
            <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='ADate' name='ADate' class="form-control" style="color:#F8F8FF" onkeypress="return onlyNumberKey(event)" required/>
               <span class="input-group-addon">
               <span class="glyphicon glyphicon-time"></span>
               </span>
            </div>
             ...
             $('#datetimepicker3').datetimepicker({
                 format: 'LT',
                    ...
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <select id="position" name="position" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>

    <option fvalue="CLASS MONITOR">CLASS MONITOR</option>
    ...
    <option selected value="STUDENT">STUDENT</option>
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <textarea class="form-control" id="Comment" name="Comment" style="height: 100px; font-size:12px;  color:gray; text-transform:uppercase; color:#F8F8FF" autocomplete="off" required></textarea>
