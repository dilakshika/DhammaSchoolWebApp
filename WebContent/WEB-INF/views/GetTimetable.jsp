...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">View Time Tables</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
  ...
  <tr>
    <td>8.00 - 9.00</td>
    <td><%=timetable.getFirstSubject()%></td>
    <td><%=timetable.getFirstLecturer()%></td>
  </tr>
  <tr>
    <td>9.00 - 10.00</td>
    <td><%=timetable.getSecondSubject()%></td>
    <td><%=timetable.getSecondLecturer()%></td>
  </tr>
  <tr>
    <td>10.00 - 11.00</td>
    <td><%=timetable.getThirdSubject()%></td>
    <td><%=timetable.getThirdLecturer()%></td>
  </tr>
  <tr>
    <td>11.00 - 12.00</td>
    <td><%=timetable.getFourthSubject()%></td>
    <td><%=timetable.getFourthLecturer()%></td>
  </tr>
...
function myFunction() {
  var sTable = document.getElementById('demo').innerHTML;
        ...
        %>
        win.document.write('<center><h2>Dhamma School - Time Table</h2></center>');
        win.document.write('<br>');
        win.document.write('<h3>Timetable Name: <%=timetable.getName()%></h3>');
        win.document.write('<h3>Timetable Year: <%=timetable.getYear()%></h3>');
        ...
        win.document.write('<table><tr> <th>Time</th> <th>Subject</th> <th>Teacher</th></tr>'); 
        win.document.write('<tr><td>8.00 - 9.00</td><td><%=timetable.getFirstSubject()%></td> <td><%=timetable.getFirstLecturer()%></td></tr>'); 
        win.document.write('<tr><td>9.00 - 10.00</td><td><%=timetable.getSecondSubject()%></td><td><%=timetable.getSecondLecturer()%></td></tr>');  
        win.document.write('<tr><td>10.00 - 11.00</td><td><%=timetable.getThirdSubject()%></td> <td><%=timetable.getThirdLecturer()%></td></tr>'); 
        win.document.write('<tr><td>11.00 - 12.00</td><td><%=timetable.getFourthSubject()%></td><td><%=timetable.getFourthLecturer()%></td></tr>'); 
        win.document.write('<br>');
