<%@page import="com.itpm.model.Timetable"%>
<!DOCTYPE html>
...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Delete Time Tables</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
				<form method="POST" action="ListTimetableServlet">
	...
	%>
  <form autocomplete="off" method="POST" action="UpdateTimetableServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
    <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Timetable ID </label>
                        <br />
                        <input id="TimetableId" disabled="disabled" name="TimetableId"  type="text" class="form-control"  style="color:#F8F8FF; text-transform:uppercase;" value="<%=timetable.getTimetableId()%>"  autocomplete="off"  required>
                    </div>
                    </div>
    <div class="row m-0 p-0">
    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Name </label>
                        <br />
                        <input id="name" disabled="disabled" name="name"  type="text" class="form-control"  style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getName()%>"   required>
                    </div>
                   <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Year </label>
                        <br />
                        <input id="year" disabled="disabled" name="year" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getYear()%>"  required>
                    </div> 
    ...
    <div class="col-md-6  h-100 w-100">
    <br/>
    <label class="lablFont">First Subject </label>
	<select id="firstSubject" name="firstSubject" disabled="disabled" stype="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>

    <option value="Pali Grammar & Literature">Pali Grammar & Literature</option>
    <option value="Buddhist Cultural Diversity in Asia">Buddhist Cultural Diversity in Asia</option>
    <option value="Elementary Buddhist Sanskrit">Elementary Buddhist Sanskrit</option>
    <option value="Theravada and Mahayana">Theravada and Mahayana</option>
    <option  value="Buddhist Ethics and Meditation">Buddhist Ethics and Meditation</option>
	<option selected value="<%=timetable.getFirstSubject()%>"><%=timetable.getFirstSubject()%></option>

  </select>
   </div>
    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">First Lecturer </label>
                        <br />
                        <input id="firstLecturer" disabled="disabled" name="firstLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getFirstLecturer()%>" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
        <br/>
    <label class="lablFont">Second Subject </label>
	<select id="secondSubject" name="secondSubject" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <option value="Theravada and Mahayana">Theravada and Mahayana</option>
    <option  value="Buddhist Ethics and Meditation">Buddhist Ethics and Meditation</option>
	<option selected value="<%=timetable.getSecondSubject()%>"><%=timetable.getSecondSubject()%></option>

  </select>
   </div>
    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Second Lecturer </label>
                        <br />
                        <input id="secondLecturer" disabled="disabled" name="secondLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getSecondLecturer()%>" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
    <br/>
    <label class="lablFont">Third Subject </label>
	<select id="thirdSubject" name="thirdSubject" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <option value="Theravada and Mahayana">Theravada and Mahayana</option>
    <option  value="Buddhist Ethics and Meditation">Buddhist Ethics and Meditation</option>
	<option selected value="<%=timetable.getThirdSubject()%>"><%=timetable.getThirdSubject()%></option>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <label class="lablFont">First Lecturer </label>
                        <br />
                        <input id="thirdLecturer" disabled="disabled" name="thirdLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getThirdLecturer()%>" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
    <br/>
    <label class="lablFont">Fourth Subject </label>
	<select id="fourthSubject" name="fourthSubject" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <option value="Theravada and Mahayana">Theravada and Mahayana</option>
    <option  value="Buddhist Ethics and Meditation">Buddhist Ethics and Meditation</option>
	<option selected value="<%=timetable.getFourthSubject()%>"><%=timetable.getFourthSubject()%></option>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <label class="lablFont">First Lecturer </label>
                        <br />
                        <input id="fourthLecturer" disabled="disabled" name="fourthLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getFourthLecturer()%>" required>
                    </div>
	...
	<form method="POST" action="DeleteTimetableServlet">
                ...
                <div class="row m-0 p-0">
					...
					value="<%=timetable.getTimetableId()%>" />
