...
<body>
	...
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="stdId" name="stdId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                    </div>
     ...
     <div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="stdGrade" name="stdGrade" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                    </div>
