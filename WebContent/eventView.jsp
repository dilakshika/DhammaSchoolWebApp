...
<body>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="login.html" aria-expanded="false"><i class="mdi mdi-power"></i><span class="hide-menu">Logout</span></a></li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add Events</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
			...
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                  <form autocomplete="off" method="POST" action="AddEventServlet" style="font-family: Arial, Helvetica, sans-serif; color: white; ">
  		...
  		<div class="row m-0 p-0">
				...
				<div class="row m-0 p-0">
				 <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <input id="place" name="place" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
				</div>
  		...
  		<div class="row m-0 p-0">
  		 <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="duration" name="duration" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Date </label>
                        <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='date' name='date' class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" required/>
  ...
  <input type="time" name="stime" id="inputMDEx1" class="form-control">
                     ...
                     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="incharg_id" name="incharg_id" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
	</div>
	<div class="row m-0 p-0">
 ...
 <div class="row m-1 p-0">
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <textarea class="form-control" id="participants" name="participants" style="height: 100px; font-size:12px; color:gray; text-transform:uppercase; color:#F8F8FF" autocomplete="off" required></textarea>
