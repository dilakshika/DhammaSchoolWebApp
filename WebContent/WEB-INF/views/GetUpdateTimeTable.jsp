...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit Time Tables</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
  ...
  <form autocomplete="off" method="POST" action="UpdateTimetableServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="name" name="name"  type="text" class="form-control"  style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getName()%>"   required>
                    </div>
                   <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Year </label>
                        <br />
                        <input id="year" name="year" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getYear()%>"  required>
                    </div> 
	...
	<select id="firstSubject" name="firstSubject" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="firstLecturer" name="firstLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getFirstLecturer()%>" required>
                    </div>
	...
	<select id="secondSubject" name="secondSubject" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="secondLecturer" name="secondLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getSecondLecturer()%>" required>
                    </div>
	...
	<select id="thirdSubject" name="thirdSubject" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <label class="lablFont">First Lecturer </label>
                        <br />
                        <input id="thirdLecturer" name="thirdLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getThirdLecturer()%>" required>
                    </div>
	...
	<select id="fourthSubject" name="fourthSubject" type="text" class="form-control" style="color:#F8F8FF; font-size12px;" class="custom-select" required>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <label class="lablFont">First Lecturer </label>
                        <br />
                        <input id="fourthLecturer" name="fourthLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=timetable.getFourthLecturer()%>" required>
                    </div>
