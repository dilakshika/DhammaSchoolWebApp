<%@page import="com.itpm.model.Result"%>
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">View Results</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
				<form method="POST" action="ListResultServlet">
	 ...
	 <form autocomplete="off" method="POST" action="GetUpdateResultServlet" style="font-family: Arial, Helvetica, sans-serif; ">
	<%
	...
	%>
     ...
     <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Result ID </label>
                        <br />
                        <input id="ResultId" name="ResultId" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"   value="<%=result.getResultId()%>" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="sid" name="sid" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=result.getSid()%>" required>
                    </div>
     </div>
   <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Student Name </label>
                        <br />
                        <input id="name" name="name" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=result.getName()%>" required>
                    </div>
     ...
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="password" name="password" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" 	value="<%=result.getPassword()%>" required>
                    </div>
   </div>
   <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="year" name="year" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=result.getYear()%>" required>
                    </div>
     ...
     <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Exam </label>
                        <br />
                        <input id="exam" name="exam" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=result.getExam()%>" required>
                    </div>
       </div>
       <div class="row m-0 p-0">             
        <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Result </label>
                        <br />
                        <input id="result" name="result" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=result.getResult()%>" required>
                    </div>
     ...
     <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Grade </label>
                        <br />
                        <input id="grade" name="grade" type="text" disabled="disabled" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" 	value="<%=result.getGrade()%>" required>
                    </div>
    </div> 
...
function myFunction() {
  var sTable = document.getElementById('demo').innerHTML;
        ...
        win.document.write('<center><h2>Dhamma School - Results</h2></center>');
        win.document.write('<br>');
        win.document.write('<h3>Result ID: <%=result.getResultId()%></h3>');
        win.document.write('<h3>Student ID: <%=result.getSid()%></h3>');
        win.document.write('<h3>Student Name: <%=result.getName()%></h3>');
        ...
        win.document.write('<table><tr><th>Exam</th><th>Year</th><th>Results</th></tr>'); 
        win.document.write('<tr><td><%=result.getExam()%></td><td><%=result.getYear()%></td><td><%=result.getResult()%></td></tr>'); 
