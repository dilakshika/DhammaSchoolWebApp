...
@WebServlet("/GetDeleteResultServlet")
public class GetDeleteResultServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public GetDeleteResultServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetdeleteResult.jsp");
