...
<%@page import="com.itpm.service.StudentServiceImpl"%>
<%@page import="com.itpm.service.IStudentService"%>
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                            ...
                            <div class="row m-0 p-0">
     						<div class="col-md-6  h-100 w-100">
                   				...
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="homeView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
        ...
        <thead>
            <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; ">
                ...
                <th style="width: 180px;">Guardian</th>
                <th style="width: 220px;">Mobile</th>
                <th style="width: 200px;">Position</th>
                <th style="width: 200px;padding-right: 0px;padding-left: 0px;height: 7px; text-align: center">Select</th>
        ...
        <tbody >
         ...
         %>
            <tr>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=student.getInNo() %> </td>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=student.getFname() %> <%=student.getIName() %>  </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=student.getGender() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=student.getGuardian() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=student.getMobile() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=student.getPosition() %> </td>	
                <td> 
             <table >
             <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetStudentServlet">
				...
				<th>
				<form method="POST" action="GetUpdateStudentServlet">
				<input type="hidden" name="InNo" value="<%=student.getInNo()%>"/>
				...
				<th>
				<form method="POST" action="GetDeleteStudentServlet">
				<input type="hidden" name="InNo" value="<%=student.getInNo()%>"/>
