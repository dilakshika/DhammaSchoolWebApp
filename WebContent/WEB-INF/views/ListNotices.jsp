...
<%@page import="com.itpm.service.NoticeServiceImpl"%>
<%@page import="com.itpm.service.INoticeService"%>
...
<body>
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                            <div class="card-body">
     						...
     						<div class="col-md-6  h-100 w-100">
                   				...
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="noticeView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
	  ...
	  <thead>
            <tr >
                <th style="width: 99px;">Notice ID</th>
                <th>Notice name</th>
                <th>Notice Date</th>
                <th>Notice Owner</th>
             ...
             <tbody >
			   <%
            	INoticeService iNoticeService = new NoticeServiceImpl();
                      ArrayList<Notice> arrayList = iNoticeService.getNotices();
				...
				<td> <%=notice.getNowner() %> </td>	
                <td> 
             <table >
             <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetNoticeServlet">
				...
				<th>
				<form method="POST" action="GetUpdateNoticeServlet">
				<input type="hidden" name="NoticeId" value="<%=notice.getNoticeId()%>"/>
				...
				<th>
				<form method="POST" action="GetDeleteNoticeServlet">
				<input type="hidden" name="NoticeId" value="<%=notice.getNoticeId()%>"/>
