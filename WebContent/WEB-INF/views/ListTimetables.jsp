...
<%@page import="com.itpm.service.TimetableServiceImpl"%>
<%@page import="com.itpm.service.ITimetableService"%>
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                            ...
                            <div class="row m-0 p-0">
     						<div class="col-md-6  h-100 w-100">
                   				<h3>List of Time Tables</h3>
                   				</div>
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="timetableView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
		...
		<thead>
            <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; ">
                <th style="width: 300px;">Timetable ID</th>
                <th style="width: 300px;">Name</th>
                <th style="width: 300px;" >Year</th>
           		 <th style="width: 100px;padding-right: 0px;padding-left: 0px;height: 7px; text-align: center">Select</th>
		 ...
		 <tbody >
          <%
            	ITimetableService iTimetableService = new TimetableServiceImpl();
                                                	ArrayList<Timetable> arrayList = iTimetableService.getTimetables();
                                                	
                                                	for(Timetable timetable : arrayList){
            %>
            <tr>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=timetable.getTimetableId() %>  </td>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=timetable.getName() %>   </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 15px"> <%=timetable.getYear() %> </td>	
                <td> 
		   <table >
             <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetTimetableServlet">
				<input type="hidden" name="TimetableId" value="<%=timetable.getTimetableId() %>"/>
				...
				<th>
				<form method="POST" action="GetUpdateTimetable">
				<input type="hidden" name="TimetableId" value="<%=timetable.getTimetableId() %>"/>
				...
				<th>
				<form method="POST" action="GetDeleteTimetableServlet">
				<input type="hidden" name="TimetableId" value="<%=timetable.getTimetableId() %>"/>
