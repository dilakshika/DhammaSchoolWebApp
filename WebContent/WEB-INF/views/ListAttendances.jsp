...
<%@page import="com.itpm.service.AttendanceServiceImpl"%>
<%@page import="com.itpm.service.IAttendanceService"%>
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                          ...
                          <div class="row m-0 p-0">
     						<div class="col-md-6  h-100 w-100">
                   				...
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="attendanceView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
        ...
        <thead>
            <tr style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; ">
                <th style="width: 150px;">Attendance ID</th>
                <th style="width: 270px;">Student ID</th>
                <th style="width: 150px;">Student Grade</th>
                <th style="width: 210px;">Student Arrives Time</th>
                <th style="width: 210px;">Student Arrives Date</th>
                <th style="width: 250px;padding-right: 0px;padding-left: 0px;height: 7px; text-align: center">Select</th>
        ...
        <tbody >
            ...
            <%
            	IAttendanceService iAttendanceService = new AttendanceServiceImpl();
                                                	ArrayList<Attendance> arrayList = iAttendanceService.getAttendances();
                                                	
                                                	for(Attendance attendance : arrayList){
            %>
			 <tr>
			 <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=attendance.getAttendanceId() %> </td>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=attendance.getStdId() %>  </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=attendance.getStdGrade() %> </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=attendance.getStdArrivesTime() %>  </td>
                <td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px"> <%=attendance.getStdArrivesDate() %> </td>
				<td> 
				<table >
             <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetAttendanceServlet">
				...
				<th>
				<form method="POST" action="GetAttendamceUpdateServlet">
				<input type="hidden" name="AttendanceId" value="<%=attendance.getAttendanceId() %>"/>
				...
				<th>
				<form method="POST" action="GetAttendanceDeleteServlet">
				<input type="hidden" name="AttendanceId" value="<%=attendance.getAttendanceId() %>"/>
