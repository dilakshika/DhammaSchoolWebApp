...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit Results</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
	 ...
	 <form autocomplete="off" method="POST" action="UpdateResultServlet" style="font-family: Arial, Helvetica, sans-serif;">
	<%
	...
	%>
     ...
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                             <input id="ResultId" name="ResultId" disabled="disabled" type="text" class="form-control" style="text-transform:uppercase; color:#F8F8FF"  autocomplete="off" value="<%=result.getResultId()%>" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                             <input id="sid" name="sid" type="text" class="form-control" style="text-transform:uppercase; color:#F8F8FF"  autocomplete="off" value="<%=result.getSid()%>" required>
                    </div>
     </div>
   <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                             <input id="name" name="name" type="text" class="form-control" style="text-transform:uppercase; color:#F8F8FF"  autocomplete="off" value="<%=result.getName()%>" required>
                    </div>
  <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Password </label>
                        <br />
                                  <input id="password" name="password" type="text" class="form-control" style="text-transform:uppercase; color:#F8F8FF"  autocomplete="off" value="<%=result.getPassword()%>" required>
   ...
   <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                    	 <select id="year" name="year" class="form-control" style="color:#F8F8FF; text-transform:uppercase;"class="custom-select" required>

    <option selected value="<%=result.getYear()%>"><%=result.getYear()%></option>
    ...
    <option value="2017">2017</option>
     ...
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                   <select id="exam" name="exam" class="form-control" style="color:#F8F8FF; text-transform:uppercase;"class="custom-select" required>

<option selected value="<%=result.getExam()%>"><%=result.getExam()%></option>
    ...
    <option value="Theravada and Mahayana">Theravada and Mahayana</option>
       ...
       <div class="row m-0 p-0">             
        <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                    <select id="result" name="result" class="form-control" style="color:#F8F8FF; text-transform:uppercase;"class="custom-select" required>

    <option selected value="<%=result.getResult()%>"><%=result.getResult()%></option>
    ...
    <option value="F">F</option>
     ...
     <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="grade" name="grade" type="text"  class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" 	value="<%=result.getGrade()%>" required>
                    </div>
    </div> 
...
<div class="row m-3 p-0">
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-6  m-0 p-0">
                        <div class="row m-0 p-0">
                            <div class="col-md-6  h-100 w-100">
                            <input type="hidden" name="ResultId"value="<%=result.getResultId()%>" /> 
