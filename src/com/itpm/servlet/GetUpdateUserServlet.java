...
/**
 * Servlet implementation class GetUpdateUserServlet
 */
@WebServlet("/GetUpdateUserServlet")
public class GetUpdateUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetUpdateUser.jsp");
