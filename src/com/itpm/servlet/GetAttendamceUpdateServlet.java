...
/**
 * Servlet implementation class GetAttendamceUpdateServlet
 */
@WebServlet("/GetAttendamceUpdateServlet")
public class GetAttendamceUpdateServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAttendamceUpdateServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetUpdateAttendance.jsp");
