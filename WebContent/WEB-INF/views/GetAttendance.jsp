...
<%@page import="com.itpm.model.Attendance"%>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">View Attendance</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
...
<form autocomplete="off" method="POST" action="UpdateAttendanceServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Attendance ID </label>
                        <br />
                        <input id="AttendanceId"  disabled="disabled" name="AttendanceId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=attendance.getAttendanceId()%>"   required>
                    </div>
                    </div>
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="stdId" disabled="disabled" name="stdId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=attendance.getStdId() %>"   required>
                    </div>
                    </div>
...
<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="stdGrade" disabled="disabled" name="stdGrade" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=attendance.getStdGrade()%>"  required>
                    </div>
                    </div>
<div class="row m-0 p-0">
 <div class="col-md-8  h-100 w-100">
         <br />
                        ...
                        <br />
  <input type="time" disabled="disabled" name="stdArrivesTime" id="inputMDEx1" class="form-control" value="<%=attendance.getStdArrivesTime()%>">
                    </div>
    ...
    <div class="row m-0 p-0">
            ...
            <div class='input-group date' id='datetimepicker3'>
               <input type='text' disabled="disabled" id='stdArrivesDate' name='stdArrivesDate' class="form-control" style="color:#F8F8FF" onkeypress="return onlyNumberKey(event)" value="<%=attendance.getStdArrivesDate()%>" required/>
...
function myFunction() {
  var sTable = document.getElementById('demo').innerHTML;
        ...
        %>
        win.document.write('<center><h2>Dhamma School - Attendance</h2></center>');
        win.document.write('<br>');
        win.document.write('<h3>Attendance ID: <%=attendance.getAttendanceId()%></h3>');
        win.document.write('<h3>Student ID: <%=attendance.getStdId()%></h3>');
        ...
        win.document.write('<table><tr><th>Student ID</th><th>Grade</th><th>Arrives Time</th><th>Arrives Date</th></tr>'); 
        win.document.write('<tr><td><%=attendance.getStdId() %></td><td><%=attendance.getStdGrade() %></td><td><%=attendance.getStdArrivesTime()%></td><td><%=attendance.getStdArrivesDate()%></td></tr>'); 
