                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit Events</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
	...
	%>
  		...
  		<div class="row m-0 p-0">
                    ...
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="name" name="name" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getName()%>"  required>
                    </div>
				...
				<div class="row m-0 p-0">
				 <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <input id="place" name="place" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getPlace()%>" required>
                    </div>
				</div>
  		...
  		<div class="row m-0 p-0">
  		 <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="duration" name="duration" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getDuration()%>"   required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Date </label>
                        <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='date' name='date' class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=event.getDate()%>"  required/>
    ...
    <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
         <br />
                        ...
                        <br />
						<input type='time' id="inputMDEx1" name="stime" class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=event.getStime()%>"  required/>
                  </div>
                     <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">In Charge ID </label>
                        <br />
                        <input id="incharg_id" name="incharg_id" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getIncharg_id()%>"  required>
                    </div>
	</div>
	<div class="row m-0 p-0">
 ...
 <div class="row m-1 p-0">
                ...
                <div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        ...
                        <br />
                        <input class="form-control" id="participants" name="participants" style="height: 100px; font-size:12px; color:gray; text-transform:uppercase; color:#F8F8FF" autocomplete="off" value="<%=event.getParticipants()%>" required/>
