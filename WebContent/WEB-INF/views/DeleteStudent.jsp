...
<body>
                        ...
                        <div class="card">
                           ...
                           <div class="row m-0 p-0">
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Delete Student</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
	...
	<form method="POST" action="GetDeleteStudentServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
	 <div class="row m-0 p-0">
	  <div class="col-md-6  h-100 w-100">
        <br />
