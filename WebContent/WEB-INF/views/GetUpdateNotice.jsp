                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Edit Notice</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
...
<div class="row m-0 p-0">
	...
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="Nname"  name="Nname" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=notice.getNname() %>"   required>
                    </div>
	...
	<div class="row m-0 p-0">
				 <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="place"  name="Nowner" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=notice.getNowner()%>"  required>
                    </div>
				</div>
...
<div class="col-md-8  h-100 w-100">
               ...
               <input type='text' id='Ndate' name='Ndate'  class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=notice.getNdate()%>"  required/>
...
<div class="row m-3 p-0"></div>
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input class="form-control"  id="Notice" name="Notice" style="height: 180px; color:gray; text-transform:uppercase; font-size: 11px; color:#F8F8FF" autocomplete="off" value="<%=notice.getNotice()%>" required>
