...
<%@page import="com.itpm.model.Notice"%>
...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">View Notice</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
				<form method="POST" action="ListNoticeServlet">
  ...
  <%
	...
	%>
 <form autocomplete="off" method="POST" action="UpdateNoticeServlet" style="font-family: Arial, Helvetica, sans-serif; ">

<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Notice ID </label>
                        <br />
                        <input id="NoticeId" disabled="disabled" name="NoticeId" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=notice.getNoticeId()%>"   required>
                    </div>
	...
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Notice Name </label>
                        <br />
                        <input id="Nname" disabled="disabled" name="Nname" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=notice.getNname() %>"   required>
                    </div>
	...
	<div class="row m-0 p-0">
				 <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Notice Owner </label>
                        <br />
                        <input id="Nowner" disabled="disabled" name="Nowner" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=notice.getNowner()%>"  required>
                    </div>
				</div>
...
<div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Notice Date </label>
                        <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='Ndate' name='Ndate' disabled="disabled" class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=notice.getNdate()%>"  required/>
...
<div class="row m-3 p-0"></div>
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <label class="lablFont">Notice </label>
                        <br />
                        <input class="form-control" disabled="disabled" id="Notice" name="Notice" style="height: 180px; font-size: 11px; color:gray; text-transform:uppercase; color:#F8F8FF" autocomplete="off" value="<%=notice.getNotice()%>" required>
...
function myFunction() {
  var sTable = document.getElementById('demo').innerHTML;
        ...
        %>
        win.document.write('<center><h2>Dhamma School - Notices</h2></center>');
        win.document.write('<br>');
        win.document.write('<h3>Notice ID: <%=notice.getNoticeId()%></h3>');
        win.document.write('<h3>Notice Name: <%=notice.getNname() %></h3>');
        ...
        win.document.write('<table><tr><th>Notice Date</th><th>Notice Owner</th><th>Notice</th></tr>'); 
        win.document.write('<tr><td><%=notice.getNdate()%></td><td><%=notice.getNowner()%></td><td><%=notice.getNotice()%></td></td></tr>'); 
