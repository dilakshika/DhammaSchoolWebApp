...
<body>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add Notice</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
  ...
  <form autocomplete="off" method="POST" action="AddNoticeServlet" style="font-family: Arial, Helvetica, sans-serif; " >
	<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        <br />
                        <label class="lablFont">Notice Name </label>
                        <br />
                        <input id="name" name="Nname" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
	...
	<div class="row m-0 p-0">
				 <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <input id="place" name="Nowner" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
				</div>
<div class="row m-0 p-0">
<div class="col-md-8  h-100 w-100">
               ...
               <input type='text' id='Ndate' name='Ndate' class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" required/>
...
<div class="row m-0 p-0">
                    <div class="col-md-8  h-100 w-100">
                        ...
                        <br />
                        <textarea class="form-control" id="Notice" name="Notice" style="height: 150px; font-size:11px; color:gray; text-transform:uppercase; color:#F8F8FF" autocomplete="off" required></textarea>
                 
                    </div>
                </div>
                <div class="row m-4 p-0"></div>
  <div class="row m-0 p-0">
