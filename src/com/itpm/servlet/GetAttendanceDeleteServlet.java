...
/**
 * Servlet implementation class GetAttendanceEditServlet
 */
@WebServlet("/GetAttendanceDeleteServlet")
public class GetAttendanceDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAttendanceDeleteServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetDeleteAttendance.jsp");
