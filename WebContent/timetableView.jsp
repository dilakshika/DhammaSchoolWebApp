...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">Add Time Tables</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
			...
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                   <form autocomplete="off" method="POST" action="AddTimetableServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
      ...
      <div class="row m-0 p-0">
                    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="name" name="name"  type="text" class="form-control"  style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off"  required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Year </label>
                        <br />
                        <input id="year" name="year" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
				</div>         
    ...
    <option selected value="Buddhist Ethics and Meditation">Buddhist Ethics and Meditation</option>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="firstLecturer" name="firstLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
                        ...
                        <br />
                        <input id="secondLecturer" name="secondLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Third Lecturer </label>
                        <br />
                        <input id="thirdLecturer" name="thirdLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
    ...
    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Fourth Lecturer </label>
                        <br />
                        <input id="fourthLecturer" name="fourthLecturer" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" required>
                    </div>
