...
<%@page import="com.itpm.model.Event"%>
...
<body>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="col-md-6  h-100 w-100">
                                <h3 class="card-title" style="font-family: Arial, Helvetica, sans-serif;">View Events</h3>
                             </div>  
                             <div class="col-md-6  h-100 w-100"> 
				<form method="POST" action="ListEventServlet">
			<input type="image" src="assets/images/CRUD/view_all.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="VIEW ALL RESULTS" alt="Submit">
                               ...
                               <div class="table-responsive">
                                  <form autocomplete="off" method="POST" action="UpdateEventServlet" style="font-family: Arial, Helvetica, sans-serif; color: gray; ">
  			<%
	...
	%>
  		...
  		<div class="row m-0 p-0">
					<div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Event ID </label>
                        <br />
                        <input id="id" name="id" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getId()%>"   required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Event Name </label>
                        <br />
                        <input id="name" name="name" disabled="disabled" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getName()%>"  required>
                    </div>
				...
				<div class="row m-0 p-0">
				 <div class="col-md-12  h-100 w-100">
                        <br />
                        <label class="lablFont">Place </label>
                        <br />
                        <input id="place" disabled="disabled" name="place" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getPlace()%>" required>
                    </div>
				</div>
  		...
  		<div class="row m-0 p-0">
  		 <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Duration </label>
                        <br />
                        <input id="duration" disabled="disabled" name="duration" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getDuration()%>"   required>
                    </div>
                    <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">Date </label>
                        <div class='input-group date' id='datetimepicker3'>
               <input type='text' id='date' name='date' disabled="disabled" class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=event.getDate()%>"  required/>
    ...
    <div class="row m-0 p-0">
     <div class="col-md-6  h-100 w-100">
         <br />
                        ...
                        <br />
						<input type='time' disabled="disabled" id="stime" name="stime" class="form-control" onkeypress="return onlyNumberKey(event)" style="color:#F8F8FF; text-transform:uppercase;" value="<%=event.getStime()%>"  required/>
                  </div>
                     <div class="col-md-6  h-100 w-100">
                        <br />
                        <label class="lablFont">In Charge ID </label>
                        <br />
                        <input id="incharg_id" disabled="disabled" name="incharg_id" type="text" class="form-control" style="color:#F8F8FF; text-transform:uppercase;" autocomplete="off" value="<%=event.getIncharg_id()%>"  required>
                    </div>
	</div>
	<div class="row m-0 p-0">
				...
				<div class="row m-1 p-0"></div>

 <div class="row m-1 p-0">
                </div>
                <div class="row m-0 p-0">
                    <div class="col-md-12  h-100 w-100">
                        <label class="lablFont">Participants </label>
                        <br />
                        <input class="form-control" disabled="disabled" id="participants" name="participants" style="height: 100px; font-size:12px; color:gray; text-transform:uppercase; color:#F8F8FF" autocomplete="off" value="<%=event.getParticipants()%>" required/>
...
function myFunction() {
  var sTable = document.getElementById('demo').innerHTML;
        ...
        %>
        win.document.write('<center><h2>Dhamma School - Events</h2></center>');
        win.document.write('<br>');
        win.document.write('<h3>Event ID: <%=event.getId()%></h3>');
        win.document.write('<h3>Event Name: <%=event.getName() %></h3>');
        ...
        win.document.write('<table><tr><th>Event Name</th><th>Place</th><th>Date</th><th>Time</th></tr>'); 
        win.document.write('<tr><td><%=event.getName()%></td><td><%=event.getPlace()%></td><td><%=event.getDate()%></td><td><%=event.getStime()%></td></tr>'); 
