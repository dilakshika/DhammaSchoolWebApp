...
/**
 * Servlet implementation class GetDeleteTimetableServlet
 */
@WebServlet("/GetDeleteTimetableServlet")
public class GetDeleteTimetableServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetDeleteTimetableServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/views/GetDeleteTimeTable.jsp");
