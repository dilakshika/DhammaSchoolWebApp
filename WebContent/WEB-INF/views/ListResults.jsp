...
<%@page import="com.itpm.service.ResultServiceImpl"%>
<%@page import="com.itpm.service.IResultService"%>
...
<body>
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card" style="background-color: white; color: black; " >
                            ...
                            <div class="row m-0 p-0">
     						<div class="col-md-6  h-100 w-100">
                   				...
                   				<div class="col-md-6  h-100 w-100">
                   				<a href="resultView.jsp"><input  type="image" src="assets/images/CRUD/plus.png" style="float: right;width:35px; height:35px" data-toggle="tooltip" data-placement="bottom" title="ADD" alt="Submit">
                   				</a>
                   				</div>
                   				</div>
        ...
        <thead>
            <tr id="table_topic" >
		<th style="width: 99px;">Result ID</th>
				 <th>Student ID</th>
                <th>Student Name</th>
                <th>Year</th>
                <th>Grade</th>
                <th>Exam</th>
                <th style="width: 224px;padding-right: 0px;padding-left: 0px;height: 7px;">Select</th>
        ...
        <tbody >
            <%
            	IResultService iResultService = new ResultServiceImpl();
                                    	ArrayList<Result> arrayList = iResultService.getResults();
                                    	
                                    	for(Result result : arrayList){
            %>
			 <tr>
				<td style="font-size: 14px"> <%=result.getResultId() %> </td>
				<td> <%=result.getSid() %> </td>
				<td> <%=result.getName() %> </td>
				<td> <%=result.getYear() %> </td>
				<td> <%=result.getGrade() %> </td>
				<td> <%=result.getExam() %> </td>
				<td>
		<table >	
				 <tr style="background-color: transparent;">
             <th>
               <form id="myform" method="POST" action="GetResultServlet">
				...
				<th>
				<form method="POST" action="GetUpdateResultServlet">
				<input type="hidden" name="ResultId" value="<%=result.getResultId()%>"/>
				...
				<th>
				<form method="POST" action="GetDeleteResultServlet">
				<input type="hidden" name="ResultId" value="<%=result.getResultId()%>"/>
